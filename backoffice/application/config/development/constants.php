...
define('FACEBOOK_TITLE','');
define('FACEBOOK_TYPE','article');
define('FACEBOOK_URL','');
define('FACEBOOK_IMAGE',''); //url to image
define('FACEBOOK_DESCRIPTION','');

define('URL_CAMPANA','http://dev-campanas.digitaria.cl/lipigas/chacoperro/');
